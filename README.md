...
### 02: Search and Rescue Mission Planning Agent
...
- Live Demo: [Hugging Face Space](https://huggingface.co/spaces/FlyingNunchucks/search-and-rescue-mission-planner) *(Hugging Face login may be required)*
